...
class App {
    ...
    private InitProdModules(): void {
        ...
        this.app.use( (_req: Request, res: Response, next: NextFunction) => { // Configurar el cors
    ...
    private InitAppRoutes(): void {
        this.app.use(`${this.config.application.BASE_URL}/SalaOperaciones`, new SalaOperaciones().getRouter());
        this.app.use(`${this.config.application.BASE_URL}/CopiaLibros`, new CopiaLibros().getRouter());
    }
