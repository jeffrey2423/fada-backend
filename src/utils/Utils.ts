module Utils {
    ...
    export function DividirCadena(cadenaADividir: string, separador: string = "",
        esSaltoDeLinea: boolean = false): any {
        ...
        try {
            ...
            if (!IsUndefinedOrNullOrEmptyOrFalse(arrayDeCadenas) && arrayDeCadenas.length <= 1) {
